...
T = TypeVar("T", bound="V1SdgGoalDataCSVPostBody")


@_attrs_define
class V1SdgGoalDataCSVPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_goal_data_csv_post_body = cls(
            goal=goal,
        ...
        v1_sdg_goal_data_csv_post_body.additional_properties = d
        return v1_sdg_goal_data_csv_post_body
