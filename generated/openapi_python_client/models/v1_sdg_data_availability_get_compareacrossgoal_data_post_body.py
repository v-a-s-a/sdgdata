...
T = TypeVar("T", bound="V1SdgDataAvailabilityGetCompareacrossgoalDataPostBody")


@_attrs_define
class V1SdgDataAvailabilityGetCompareacrossgoalDataPostBody:
    """
    Attributes:
        ...
        goals (list[str] | Unset): List of goal ids e.g 1,2
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_data_availability_get_compareacrossgoal_data_post_body = cls(
            data_point_type=data_point_type,
            nature_of_data=nature_of_data,
            goals=goals,
        )

        v1_sdg_data_availability_get_compareacrossgoal_data_post_body.additional_properties = d
        return v1_sdg_data_availability_get_compareacrossgoal_data_post_body
