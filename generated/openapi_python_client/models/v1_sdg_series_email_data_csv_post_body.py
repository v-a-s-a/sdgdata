...
T = TypeVar("T", bound="V1SdgSeriesEmailDataCSVPostBody")


@_attrs_define
class V1SdgSeriesEmailDataCSVPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_series_email_data_csv_post_body = cls(
        ...
        v1_sdg_series_email_data_csv_post_body.additional_properties = d
        return v1_sdg_series_email_data_csv_post_body
