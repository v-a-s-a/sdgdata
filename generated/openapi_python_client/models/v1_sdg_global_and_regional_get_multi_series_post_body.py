...
T = TypeVar("T", bound="V1SdgGlobalAndRegionalGetMultiSeriesPostBody")


@_attrs_define
class V1SdgGlobalAndRegionalGetMultiSeriesPostBody:
    """
    Attributes:
        indicators (list[str] | Unset):
        series_code (list[str] | Unset): List of series codes along with dimension e.g
            SP_ACS_BSRVH2O-RURAL,SP_ACS_BSRVH2O-ALLAREA
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_global_and_regional_get_multi_series_post_body = cls(
        ...
        v1_sdg_global_and_regional_get_multi_series_post_body.additional_properties = d
        return v1_sdg_global_and_regional_get_multi_series_post_body
