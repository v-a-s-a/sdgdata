...
T = TypeVar("T", bound="ApiObservationPage")


@_attrs_define
class ApiObservationPage:
    """
    Attributes:
        ...
        data (list[ApiObservation] | Unset): Gets or Sets data
    """
    ...
    data: list[ApiObservation] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApiObservation.from_dict(data_item_data)

                data.append(data_item)

        api_observation_page = cls(
            size=size,
        ...
        api_observation_page.additional_properties = d
        return api_observation_page
