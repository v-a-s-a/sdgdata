...
T = TypeVar("T", bound="V1SdgSeriesGeoAreaCodePostBody")


@_attrs_define
class V1SdgSeriesGeoAreaCodePostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_series_geo_area_code_post_body = cls(
            series_codes=series_codes,
        )

        v1_sdg_series_geo_area_code_post_body.additional_properties = d
        return v1_sdg_series_geo_area_code_post_body
