...
T = TypeVar("T", bound="V1SdgSeriesPivotDataExcelPostBody")


@_attrs_define
class V1SdgSeriesPivotDataExcelPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_series_pivot_data_excel_post_body = cls(
        ...
        v1_sdg_series_pivot_data_excel_post_body.additional_properties = d
        return v1_sdg_series_pivot_data_excel_post_body
