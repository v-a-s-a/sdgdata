...
T = TypeVar("T", bound="V1SdgDataAvailabilityGetIndicatorsAllCountriesPostBody")


@_attrs_define
class V1SdgDataAvailabilityGetIndicatorsAllCountriesPostBody:
    """
    Attributes:
        ...
        country_id (int): country code (int) e.g 0 for all countries
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_data_availability_get_indicators_all_countries_post_body = cls(
            data_point_type=data_point_type,
            country_id=country_id,
            nature_of_data=nature_of_data,
        )

        v1_sdg_data_availability_get_indicators_all_countries_post_body.additional_properties = d
        return v1_sdg_data_availability_get_indicators_all_countries_post_body
