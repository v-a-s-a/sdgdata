...
T = TypeVar("T", bound="V1SdgSeriesDataExcelPostBody")


@_attrs_define
class V1SdgSeriesDataExcelPostBody:
    """
    Attributes:
        series_codes (list[str] | Unset): Code for that series
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_series_data_excel_post_body = cls(
        ...
        v1_sdg_series_data_excel_post_body.additional_properties = d
        return v1_sdg_series_data_excel_post_body
