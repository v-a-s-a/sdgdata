...
T = TypeVar("T", bound="V1SdgSeriesEmailDataExcelPostBody")


@_attrs_define
class V1SdgSeriesEmailDataExcelPostBody:
    """
    Attributes:
        ...
        email (str | Unset): Email to which the link will be send
        firstname (str | Unset):
        lastname (str | Unset):
        usertype (str | Unset):
        comments (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_series_email_data_excel_post_body = cls(
        ...
        v1_sdg_series_email_data_excel_post_body.additional_properties = d
        return v1_sdg_series_email_data_excel_post_body
