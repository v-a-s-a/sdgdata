...
T = TypeVar("T", bound="V1SdgDataAvailabilityGetSeriesAggregationsForMapsPostBody")


@_attrs_define
class V1SdgDataAvailabilityGetSeriesAggregationsForMapsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_sdg_data_availability_get_series_aggregations_for_maps_post_body = cls(
            data_point_type=data_point_type,
            goal_id=goal_id,
            nature_of_data=nature_of_data,
        )

        v1_sdg_data_availability_get_series_aggregations_for_maps_post_body.additional_properties = d
        return v1_sdg_data_availability_get_series_aggregations_for_maps_post_body
