...
#   filename:  un-api-openapi.json
#   timestamp: 2025-11-08T14:30:08+00:00
...
class ApiGeoArea(BaseModel):
    geoAreaCode: Optional[str] = Field(
        None, description='geoAreaCode is equivalent to M49'
    )
    geoAreaName: Optional[str] = Field(
        None,
...
class ApiGeoTree(BaseModel):
    ...
    children: Optional[List[ApiGeoTree]] = Field(
        None, description='Gets or Sets children'
    )
...
class ApiObservation(BaseModel):
    ...
    seriesDescription: Optional[str] = Field(
        None, description='Gets or Sets Series Description'
    )
    ...
    timePeriodStart: Optional[float] = Field(
        None, description='Gets or Sets timePeriod Start'
    )
    ...
    attributes: Optional[Dict[str, str]] = Field(
        None, description='Gets or Sets Attributes'
    )
    dimensions: Optional[Dict[str, str]] = Field(
        None, description='Gets or Sets Dimensions'
    )
...
class ApiObservationPivot(BaseModel):
    ...
    name_of_international_agreement: Optional[str] = Field(
        None, description='Gets or Sets name of international agreement'
    )
    education_level: Optional[str] = Field(
        None, description='Gets or Sets education level'
    )
    type_of_product: Optional[str] = Field(
        None, description='Gets or Sets type of product'
    )
    type_of_facilities: Optional[str] = Field(
        None, description='Gets or Sets type of facilities'
    )
    name_of_international_institution: Optional[str] = Field(
        None, description='Gets or Sets name of international institution'
    )
    type_of_occupation: Optional[str] = Field(
        None, description='Gets or Sets type of occupation'
    )
    tariff_regime_status: Optional[str] = Field(
        None, description='Gets or Sets tariff regime status'
    )
    mode_of_transportation: Optional[str] = Field(
        None, description='Gets or Sets mode of transportation'
    )
    type_of_mobile_technology: Optional[str] = Field(
        None, description='Gets or Sets type of mobile technology'
    )
    name_of_non_communicable_disease: Optional[str] = Field(
    ...
    migratory_status: Optional[str] = Field(
        None, description='Gets or Sets migratory status'
    )
    disability_status: Optional[str] = Field(
        None, description='Gets or Sets disability status'
    )
    ...
    policy_domains: Optional[str] = Field(
        None, description='Gets or Sets Policy Domains'
    )
...
class ApiSerieData(BaseModel):
    ...
    description: Optional[str] = Field(None, description='Gets or Sets Description')
    uri: Optional[str] = Field(None, description='Gets or Sets URI')
    observations: Optional[List[ApiObservation]] = Field(
        None, description='Gets or Sets attributes'
    )
...
class ApiDimension(BaseModel):
    ...
    codes: Optional[List[ApiCodeList]] = Field(
        None, description='Gets or Sets codeList'
    )
...
class ApiObservationPage(BaseModel):
    ...
    attributes: Optional[List[ApiDimension]] = Field(
        None, description='Gets or Sets attributes'
    )
    dimensions: Optional[List[ApiDimension]] = Field(
        None, description='Gets or Sets dimensions'
    )
...
class ApiObservationPivotPage(BaseModel):
    ...
    data: Optional[List[ApiObservationPivot]] = Field(
        None, description='Gets or Sets data'
    )
...
class ApiIndicatorData(BaseModel):
    ...
    tier: Optional[str] = Field(None, description='Gets or Sets Tier')
    uri: Optional[str] = Field(None, description='Gets or Sets URI')
    series: Optional[List[ApiSerieData]] = Field(
        None, description='Gets or Sets Series'
    )
...
class ApiTarget(BaseModel):
    ...
    description: Optional[str] = Field(None, description='Gets or Sets Description')
    uri: Optional[str] = Field(None, description='Gets or Sets URI')
    indicators: Optional[List[ApiIndicator]] = Field(
        None, description='Gets or Sets Indicators'
    )
...
class ApiTargetData(BaseModel):
    ...
    description: Optional[str] = Field(None, description='Gets or Sets Description')
    URI: Optional[str] = Field(None, description='Gets or Sets URI')
    indicators: Optional[List[ApiIndicatorData]] = Field(
        None, description='Gets or Sets Indicators'
    )
...
class ApiGoalData(BaseModel):
    ...
    description: Optional[str] = Field(None, description='Gets or Sets Description')
    uri: Optional[str] = Field(None, description='Gets or Sets URI')
    targets: Optional[List[ApiTargetData]] = Field(
        None, description='Gets or Sets Targets'
    )


ApiGeoTree.update_forward_refs()
